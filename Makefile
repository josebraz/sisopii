...
server: server.obj
	g++ -o build/server main.o logs.o persistence.o server_comm_manager.o server_notif_manager.o session_manager.o communication_utils.o -lpthread
...
server.obj: server/main.cpp logs.cpp communication_utils.cpp server/persistence.cpp server/server_comm_manager.cpp server/server_notif_manager.cpp server/session_manager.cpp
	g++ -c server/main.cpp logs.cpp communication_utils.cpp server/persistence.cpp server/server_comm_manager.cpp server/server_notif_manager.cpp server/session_manager.cpp
